...
#             friends = Friend.objects.get(from_user=instance.pk)
#         except:
#             profile = None
#             friends = None
#         return {
...
#             "user_count": instance.friends.count(),
#             "friends": FriendSerializer(User.objects.filter(pk__in=friends.friends.values_list('pk',flat=True)),many=True).data if friends else [],
...
class ProfileSerializer(serializers.ModelSerializer):
    class Meta:
        model = Profile
        fields = ('user', 'bio', 'profileimg', 'country')
